                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(4.0),
                            border:
                                Border.all(color: Color(0xffb1b1b1), width: 1),
                          ),
                          child: SingleChildScrollView(
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
...
class RPSCustomPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path0.quadraticBezierTo(size.width*0.3829000,size.height*0.9155420,size.width*0.4991211,size.height*0.8536496);
    path0.cubicTo(size.width*0.6206750,size.height*0.8150792,size.width*0.7060303,size.height*0.8346061,size.width*0.7750000,size.height*0.8282582);
    path0.quadraticBezierTo(size.width*0.8919750,size.height*0.8306943,size.width*0.9991211,size.height*0.7927483);
